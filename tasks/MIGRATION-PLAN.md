...
1. KILL/DIE now use direct death lifecycle with revival/drop authority,
   ...
   Hero armour/combined amulet authority passes focused/archive/race/broad; UltimateEnhancer passes focused/archive/race/broad; Taoist selector passes focused; next Poisoning metadata/dispatch. TRIGGER preserves callback/NPCUpdate order. RELOADNPCS drains goods/reloads scripts;
