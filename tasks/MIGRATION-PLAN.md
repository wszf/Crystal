...
1. KILL/DIE now use direct death lifecycle with revival/drop authority,
   ...
   Hero armour/combined amulet authority passes focused/archive/race/broad; UltimateEnhancer passes focused/archive/race/broad; next Taoist offensive selection. TRIGGER preserves callback/NPCUpdate order. RELOADNPCS drains goods/reloads scripts;
