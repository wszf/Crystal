...
1. KILL/DIE now use direct death lifecycle with revival/drop authority,
   ...
   Hero armour/combined amulet authority passes focused/archive/race/broad; UltimateEnhancer gates pass focused; next Hero dispatch. TRIGGER preserves callback/NPCUpdate order. RELOADNPCS drains goods/reloads scripts;
